...
#Preview("Light Mode") {
    VStack(spacing: 12) {
        ESButton(title: "Horizontal", icon: "pencil", color: .success, style: .horizontal)
        ESButton(title: "Vertical", icon: "trash", color: .danger, style: .vertical)
        ESButton(title: "Grid", icon: "person", style: .fixedGrid(width: 100, height: 80))
        ESButton(title: "Full Width", icon: "checkmark", color: .info, style: .fullWidth)
        ESButton(title: "Tag", icon: "star", color: .warning, style: .tag)
